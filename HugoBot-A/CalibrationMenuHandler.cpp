...
CalibrationMenuHandler::CalibrationMenuHandler(EditMenu& menu, Adafruit_ST7735& display, Adafruit_seesaw& ss)
  : menu(&menu), display(&display), encoder(&ss) {}

void CalibrationMenuHandler::Handle() {
  Serial.println("Callibration menu handling....");
