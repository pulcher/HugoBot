...
void u8g2_mag_calibrtated_string() {
  // String(sensorValue.un.linearAcceleration.x), 
  // String(sensorValue.un.magneticField.y), 
  // String(sensorValue.un.magneticField.z)
  u8g2_prepare();
  u8g2.setFontDirection(0);
  u8g2.drawStr(0, 7, String(sensorValue.un.linearAcceleration.x).c_str());
  u8g2.drawStr(0, 15, String(sensorValue.un.linearAcceleration.y).c_str());
  u8g2.drawStr(0, 23, String(sensorValue.un.linearAcceleration.z).c_str());
}
